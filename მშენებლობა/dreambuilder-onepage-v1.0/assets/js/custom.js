...
======================================*/
	...
	// 5. welcome animation support
        ...
        $(window).load(function(){
        	$(".single-slide-item-content h2,.single-slide-item p").addClass("animated fadeInUp").css({'opacity':'0'});
            $(".single-slide-item-content a").addClass("animated fadeInDown").css({'opacity':'0'});
        });
